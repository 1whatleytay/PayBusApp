    ...
    render() {
        ...
        return (
            ...
            <View style={{flex:1, justifyContent:"center", alignContent:"center", alignSelf:"center"}}>
                <Text style={{fontSize:50, color:"#222"}}>Route #{ this.props.navigation.state["params"]["id"] }</Text>
                <Text style={{fontSize:30, color:"#444"}}>Entry: { this.props.navigation.state["params"]["entry"] }</Text>
                <Text style={{fontSize:30, color:"#444"}}>Distination: { this.props.navigation.state["params"]["exit"] }</Text>
            </View>
            <View>
